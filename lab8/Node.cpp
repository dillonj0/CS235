...
void Node::setBalance(int newBalance){
    cout << "*** IN NODE SET BALANCE (data) ***" << endl;
    balance = newBalance;
}
void Node::setBalance(){
    cout << "*** IN NODE SET BALANCE (auto) ***" << endl;
    int rHeight = 0;
    int lHeight = 0;
    if (right != NULL){
    ...
    cout << "Node: " << data << " Balance: " << balance << endl;
}