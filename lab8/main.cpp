...
//    AVL* testptr = new AVL();
//
//    //ADD UP TO 20 NODES TO THE TREE
//    for (int i = 0; i < 20; i++) {
//        int n;
//        cout << "Input new integer to add to AVL (-1 to exit)" << endl;
//        cin >> n;
//        if (n == -1){
//            i = 21;
//        }
//        else {
//            testptr->add(n);
//            cout << BSTtoString(testptr);
//        }
//    }
//    cout << "Height: " << testptr->getRootNode()->getHeight() << endl;
//    cout << "R Height: " << testptr->getRootNode()->getRightChild()->getHeight() << endl;
//    cout << "L Height: " << testptr->getRootNode()->getLeftChild()->getHeight() << endl;
//
//    // REMOVE UP TO 20 NODES FROM THE TREE
//    for (int i = 0; i < 20; i ++){
//        int n;
//        cout << "Input integer to remove from AVL (-1 to exit)" << endl;
//        cin >> n;
//        if (n == -1){
//            i = 21;
//        }
